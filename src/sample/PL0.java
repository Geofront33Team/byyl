...
public class PL0 {
    ...
    public static final String tableFile = "table.txt";
    public static final String runtimeFile = "runtime.txt";
    public static final String errFile = "error.txt";
